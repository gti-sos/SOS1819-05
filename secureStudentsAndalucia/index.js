module.exports = function(app, API_PATH_SECURE, studentsAndalucia){
...
/*---------------------------------------*/
//LOADINITIALDATA
app.get(API_PATH_SECURE + "/students-andalucia/loadInitialData", (req, res) => {
...
app.get(API_PATH_SECURE + "/students-andalucia", (req, res) => {
...
app.post(API_PATH_SECURE + "/students-andalucia", (req, res) => {
...
app.delete(API_PATH_SECURE + "/students-andalucia", (req, res) => {
...
app.get(API_PATH_SECURE + "/students-andalucia/:city", (req, res) => {
...
app.delete(API_PATH_SECURE + "/students-andalucia/:city", (req, res) => {
...
//POST incorrecto
app.post(API_PATH_SECURE + "/students-andalucia/:city", (req, res) => {
    res.sendStatus(405);
});

//PUT incorrecto
app.put(API_PATH_SECURE + "/students-andalucia/", (req, res) => {
    res.sendStatus(405);
});
